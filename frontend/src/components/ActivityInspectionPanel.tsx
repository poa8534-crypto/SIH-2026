      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="border border-hair rounded-lg p-3 bg-surface/40 flex flex-col gap-2.5">
          <div className="flex items-start justify-between gap-2">
            <h2 className="font-medium text-sm text-fg leading-snug">
              {activity.description}
            </h2>
            <DisciplineTag discipline={activity.discipline} />
          </div>

          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-hair font-mono text-[11px]">
            <FieldItem label="WBS Code">
              {activity.wbs_path || 'WBS 2.4.1 (Area-02)'}
            </FieldItem>
            <FieldItem label="Engineer Log Ref">
              {activity.calendar ? `${activity.calendar} Calendar` : 'Log #8931-REV2'}
            </FieldItem>
          </div>

          {/* Planned vs Actual Mini Grid */}
          <div className="border border-hair rounded overflow-hidden text-label font-mono mt-1">
            <div className="grid grid-cols-3 bg-raised border-b border-hair text-muted uppercase text-[9px] tracking-wider px-2 py-1 font-semibold">
              <span>Metric</span>
              <span className="border-l border-hair pl-2">Planned</span>
              <span className="border-l border-hair pl-2">Actual</span>
            </div>
            <div className="grid grid-cols-3 border-b border-hair px-2 py-1.5">
              <span className="text-muted">Start Date</span>
              <span className="text-muted border-l border-hair pl-2">
                {activity.planned_start ?? '—'}
              </span>
              <span className="text-fg border-l border-hair pl-2">
                <DateCell
            ...
            <div className="grid grid-cols-3 px-2 py-1.5 bg-surface/30">
              <span className="text-muted">Quantity</span>
              <span className="text-muted border-l border-hair pl-2">
                {activity.planned_qty} {activity.uom}
              </span>
              <span className="text-fg border-l border-hair pl-2 font-semibold">
        ...
        {/* ── AI Understanding & Natural Language Verification Card ───────── */}
        <div className="border border-emerald-300/80 bg-emerald-50/50 dark:bg-emerald-950/20 dark:border-emerald-800 rounded-lg p-3 flex flex-col gap-2.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-[10px] text-emerald-700 dark:text-emerald-400">
                  Matched Daily Field Log &amp; Site Photo Exif
                </div>
              </div>
            </div>
          ...
          <div className="bg-raised border border-hair rounded p-2 text-label font-mono flex flex-col gap-1 text-muted">
            <div className="flex items-center gap-1.5 text-fg font-semibold text-[11px]">
              ...
              <span>AI Entity &amp; Progress Understanding:</span>
            </div>
        ...
        {/* ── EVIDENCE & VERIFICATION DOSSIER (The Evidence Tab) ──────────── */}
        ...
        <div className="border border-hair rounded-lg p-3 bg-surface/40 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            >
              {isAuditOpen ? <ChevronUp size={14} /> : <ChevronDown size={14} />}
            </button>
          </div>
          {isAuditOpen && <AuditTrail activityId={activity.activity_id} />}
        </div>
      </div>
      ...
      <div className="p-3 border-t border-hair bg-surface/60 shrink-0 flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 py-2 px-3 rounded bg-accent text-on-accent font-semibold text-xs hover:bg-accent/90 transition-colors shadow-sm flex items-center justify-center gap-1.5 active:scale-[0.99]"
            type="button"
          >
