...
const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  'en-IN': {
    ...
    'schedule_verification_sub': 'Matched against the active schedule baseline.',
  ...
  'hi-IN': {
    ...
    'schedule_verification_sub': 'सक्रिय शेड्यूल बेसलाइन से मिलान किया गया।',
  ...
  'as-IN': {
    ...
    'schedule_verification_sub': 'সক্ৰিয় সময়সূচী বেচলাইনৰ সৈতে মিলোৱা হৈছে।',
