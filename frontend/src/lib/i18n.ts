...
const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  'en-IN': {
    ...
    'report_details_sub': 'Structured parameters (optional) to strengthen automated schedule linking.',
    'quantity': 'Quantity',
    'unit': 'Unit',
  ...
  'hi-IN': {
    ...
    'report_details_sub': 'स्वचालित शेड्यूल लिंकिंग को मजबूत करने के लिए संरचित पैरामीटर (वैकल्पिक)।',
  ...
  'as-IN': {
    ...
    'report_details_sub': 'স্বয়ংক্ৰিয় সময়সূচী সংযোগৰ বাবে গঠিত পেৰামিটাৰ (ঐচ্ছিক)।',
