...
from .EAEtrainer import PAIEEAETrainer, EAE_collate_fn

logger = logging.getLogger(__name__)


class PAIEACTrainer(EAEACMixin, PAIEEAETrainer):
    """AC trainer for PAIE (EAE-based, two-stage hierarchical inference)."""
