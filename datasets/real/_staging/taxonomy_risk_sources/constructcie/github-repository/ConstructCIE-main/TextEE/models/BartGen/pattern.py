patterns = {
    ...
    "accd": { 'acc_txt': { 'roles': ['caught_in_between', 'electrocution', 'fall', 'struck_by'],
               'template': 'accident report: <arg1> caught in between, <arg2> electrocution, <arg3> fall, <arg4> '
                           'struck by'},
  'caught_in_between': { 'roles': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
                         'template': 'caught in between: <arg1> working circumstances, <arg2> managerial factors, '
                                     '<arg3> working condition factors, <arg4> equipment factors, <arg5> behavioral '
                                     'factors, <arg6> consequences'},
  'cond_factor': { 'roles': ['weather', 'site_cond'],
                   'template': 'working condition factors: <arg1> weather condition, <arg2> workspace condition'},
  'consq': {'roles': ['severity', 'body_part'], 'template': 'consequences: <arg1> severity, <arg2> affected body part'},
  'electrocution': { 'roles': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
                     'template': 'electrocution: <arg1> working circumstances, <arg2> managerial factors, <arg3> '
                                 'working condition factors, <arg4> equipment factors, <arg5> behavioral factors, '
                                 '<arg6> consequences'},
  'equip_factor': { 'roles': ['ppe_cond', 'tool_cond'],
                    'template': 'equipment factors: <arg1> protective equipment condition, <arg2> work equipment '
                                'condition'},
  'fall': { 'roles': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
            'template': 'fall: <arg1> working circumstances, <arg2> managerial factors, <arg3> working condition '
                        'factors, <arg4> equipment factors, <arg5> behavioral factors, <arg6> consequences'},
  'human_factor': { 'roles': ['inattention', 'violation'],
                    'template': 'behavioral factors: <arg1> inattentive behavior, <arg2> noncompliant behavior'},
  'mgmt_factor': { 'roles': ['haz_id_fail', 'train_gap'],
                   'template': 'managerial factors: <arg1> failure of hazard management, <arg2> deficiency in safety '
                               'training'},
  'struck_by': { 'roles': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
                 'template': 'struck by: <arg1> working circumstances, <arg2> managerial factors, <arg3> working '
                             'condition factors, <arg4> equipment factors, <arg5> behavioral factors, <arg6> '
                             'consequences'},
  'work_ctx': { 'roles': ['task', 'object'],
                'template': 'working circumstances: <arg1> construction trade, <arg2> object involved'}},
}