patterns = {
    ...
    "accd": { 'caught_in_between': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
  'cond_factor': ['weather', 'site_cond'],
  'consq': ['severity', 'body_part'],
  'electrocution': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
  'equip_factor': ['ppe_cond', 'tool_cond'],
  'fall': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
  'human_factor': ['inattention', 'violation'],
  'mgmt_factor': ['haz_id_fail', 'train_gap'],
  'struck_by': ['work_ctx', 'mgmt_factor', 'cond_factor', 'equip_factor', 'human_factor', 'consq'],
  'work_ctx': ['task', 'object']},
}
