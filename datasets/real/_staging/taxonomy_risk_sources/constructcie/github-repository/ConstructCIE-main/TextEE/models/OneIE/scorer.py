...
def score_graphs(gold_graphs, pred_graphs,
    ...
    scores = {
        'entity':     {'prec': entity_prec,     'rec': entity_rec,     'f': entity_f,
                       'pred_num': pred_ent_num,     'gold_num': gold_ent_num,     'match_num': ent_match_num},
        'mention':    {'prec': mention_prec,    'rec': mention_rec,    'f': mention_f,
                       'pred_num': pred_men_num,     'gold_num': gold_men_num,     'match_num': men_match_num},
        'trigger':    {'prec': trigger_prec,    'rec': trigger_rec,    'f': trigger_f,
                       'pred_num': pred_trigger_num, 'gold_num': gold_trigger_num, 'match_num': trigger_class_num},
        'trigger_id': {'prec': trigger_id_prec, 'rec': trigger_id_rec, 'f': trigger_id_f,
                       'pred_num': pred_trigger_num, 'gold_num': gold_trigger_num, 'match_num': trigger_idn_num},
        'relation':   {'prec': relation_prec,   'rec': relation_rec,   'f': relation_f,
                       'pred_num': pred_rel_num,     'gold_num': gold_rel_num,     'match_num': rel_match_num},
        'role':       {'prec': role_prec,       'rec': role_rec,       'f': role_f,
                       'pred_num': pred_arg_num,     'gold_num': gold_arg_num,     'match_num': arg_class_num},
        'role_id':    {'prec': role_id_prec,    'rec': role_id_rec,    'f': role_id_f,
                       'pred_num': pred_arg_num,     'gold_num': gold_arg_num,     'match_num': arg_idn_num},
    }
    return scores
