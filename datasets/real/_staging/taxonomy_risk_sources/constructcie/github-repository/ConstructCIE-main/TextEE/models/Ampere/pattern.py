patterns = {
    ...
    "accd": {
        'caught_in_between': {
            'event subtype': 'caught in between',
            'event type': 'caught_in_between',
            'keywords': [],
            'event description': 'The event is related to a caught in between in a construction accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Working Circumstances {ROLE_work_ctx} Working Circumstances 2 {ROLE_work_ctx2} Managerial Factors {ROLE_mgmt_factor} Managerial Factors 2 {ROLE_mgmt_factor2} Working Condition Factors {ROLE_cond_factor} Working Condition Factors 2 {ROLE_cond_factor2} Equipment Factors {ROLE_equip_factor} Equipment Factors 2 {ROLE_equip_factor2} Behavioral Factors {ROLE_human_factor} Behavioral Factors 2 {ROLE_human_factor2} Consequences {ROLE_consq} Consequences 2 {ROLE_consq2} Consequences 3 {ROLE_consq3}',
            'valid roles': ['work_ctx', 'work_ctx2', 'mgmt_factor', 'mgmt_factor2', 'cond_factor', 'cond_factor2', 'equip_factor', 'equip_factor2', 'human_factor', 'human_factor2', 'consq', 'consq2', 'consq3'],
        },
        'electrocution': {
            'event subtype': 'electrocution',
            'event type': 'electrocution',
            'keywords': [],
            'event description': 'The event is related to a electrocution in a construction accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Working Circumstances {ROLE_work_ctx} Working Circumstances 2 {ROLE_work_ctx2} Managerial Factors {ROLE_mgmt_factor} Working Condition Factors {ROLE_cond_factor} Working Condition Factors 2 {ROLE_cond_factor2} Equipment Factors {ROLE_equip_factor} Equipment Factors 2 {ROLE_equip_factor2} Behavioral Factors {ROLE_human_factor} Behavioral Factors 2 {ROLE_human_factor2} Consequences {ROLE_consq} Consequences 2 {ROLE_consq2} Consequences 3 {ROLE_consq3}',
            'valid roles': ['work_ctx', 'work_ctx2', 'mgmt_factor', 'cond_factor', 'cond_factor2', 'equip_factor', 'equip_factor2', 'human_factor', 'human_factor2', 'consq', 'consq2', 'consq3'],
        },
        'fall': {
            'event subtype': 'fall',
            'event type': 'fall',
            'keywords': [],
            'event description': 'The event is related to a fall in a construction accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Working Circumstances {ROLE_work_ctx} Managerial Factors {ROLE_mgmt_factor} Working Condition Factors {ROLE_cond_factor} Working Condition Factors 2 {ROLE_cond_factor2} Equipment Factors {ROLE_equip_factor} Equipment Factors 2 {ROLE_equip_factor2} Behavioral Factors {ROLE_human_factor} Behavioral Factors 2 {ROLE_human_factor2} Consequences {ROLE_consq} Consequences 2 {ROLE_consq2} Consequences 3 {ROLE_consq3}',
            'valid roles': ['work_ctx', 'mgmt_factor', 'cond_factor', 'cond_factor2', 'equip_factor', 'equip_factor2', 'human_factor', 'human_factor2', 'consq', 'consq2', 'consq3'],
        },
        'struck_by': {
            'event subtype': 'struck by',
            'event type': 'struck_by',
            'keywords': [],
            'event description': 'The event is related to a struck by in a construction accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Working Circumstances {ROLE_work_ctx} Working Circumstances 2 {ROLE_work_ctx2} Managerial Factors {ROLE_mgmt_factor} Working Condition Factors {ROLE_cond_factor} Working Condition Factors 2 {ROLE_cond_factor2} Equipment Factors {ROLE_equip_factor} Equipment Factors 2 {ROLE_equip_factor2} Behavioral Factors {ROLE_human_factor} Consequences {ROLE_consq} Consequences 2 {ROLE_consq2} Consequences 3 {ROLE_consq3}',
            'valid roles': ['work_ctx', 'work_ctx2', 'mgmt_factor', 'cond_factor', 'cond_factor2', 'equip_factor', 'equip_factor2', 'human_factor', 'consq', 'consq2', 'consq3'],
        },
        'work_ctx': {
            'event subtype': 'working circumstances',
            'event type': 'work_ctx',
            'keywords': [],
            'event description': 'The event is related to physical and operational contexts present at the time of the accident that characterize the immediate work situation.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Construction Trade {ROLE_task} Object Involved {ROLE_object} Object Involved 2 {ROLE_object2}',
            'valid roles': ['task', 'object', 'object2'],
        },
        'mgmt_factor': {
            'event subtype': 'managerial factors',
            'event type': 'mgmt_factor',
            'keywords': [],
            'event description': 'The event is related to deficiencies at the organizational or supervisory level that allowed unsafe conditions or behaviors to exist.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Failure of Hazard Management {ROLE_haz_id_fail} Failure of Hazard Management 2 {ROLE_haz_id_fail2} Deficiency in Safety Training {ROLE_train_gap} Deficiency in Safety Training 2 {ROLE_train_gap2}',
            'valid roles': ['haz_id_fail', 'haz_id_fail2', 'train_gap', 'train_gap2'],
        },
        'cond_factor': {
            'event subtype': 'working condition factors',
            'event type': 'cond_factor',
            'keywords': [],
            'event description': 'The event is related to physical conditions of the work environment, such as natural conditions and workspace characteristics, that contributed to the occurrence of the accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Weather Condition {ROLE_weather} Workspace Condition {ROLE_site_cond} Workspace Condition 2 {ROLE_site_cond2} Workspace Condition 3 {ROLE_site_cond3}',
            'valid roles': ['weather', 'site_cond', 'site_cond2', 'site_cond3'],
        },
        'equip_factor': {
            'event subtype': 'equipment factors',
            'event type': 'equip_factor',
            'keywords': [],
            'event description': 'The event is related to conditions related to personal or collective protective equipment or work equipment whose state contributed to the accident sequence.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Protective Equipment Condition {ROLE_ppe_cond} Protective Equipment Condition 2 {ROLE_ppe_cond2} Work Equipment Condition {ROLE_tool_cond} Work Equipment Condition 2 {ROLE_tool_cond2} Work Equipment Condition 3 {ROLE_tool_cond3} Work Equipment Condition 4 {ROLE_tool_cond4}',
            'valid roles': ['ppe_cond', 'ppe_cond2', 'tool_cond', 'tool_cond2', 'tool_cond3', 'tool_cond4'],
        },
        'human_factor': {
            'event subtype': 'behavioral factors',
            'event type': 'human_factor',
            'keywords': [],
            'event description': 'The event is related to task-level human factors involving cognitive lapses or procedural deviations that directly contributed to the occurrence of the accident.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Inattentive Behavior {ROLE_inattention} Inattentive Behavior 2 {ROLE_inattention2} Noncompliant Behavior {ROLE_violation} Noncompliant Behavior 2 {ROLE_violation2}',
            'valid roles': ['inattention', 'inattention2', 'violation', 'violation2'],
        },
        'consq': {
            'event subtype': 'consequences',
            'event type': 'consq',
            'keywords': [],
            'event description': 'The event is related to the adverse outcomes of the incident, including the seriousness of injury and the part(s) of the body affected.',
            'ED template': 'Event trigger is {Trigger}.',
            'AC template': 'Severity {ROLE_severity} Affected Body Part {ROLE_body_part} Affected Body Part 2 {ROLE_body_part2} Affected Body Part 3 {ROLE_body_part3} Affected Body Part 4 {ROLE_body_part4} Affected Body Part 5 {ROLE_body_part5} Affected Body Part 6 {ROLE_body_part6} Affected Body Part 7 {ROLE_body_part7} Affected Body Part 8 {ROLE_body_part8}',
            'valid roles': ['severity', 'body_part', 'body_part2', 'body_part3', 'body_part4', 'body_part5', 'body_part6', 'body_part7', 'body_part8'],
        },
        'role_alias': {
            'body_part2': 'body_part',
            'body_part3': 'body_part',
            'body_part4': 'body_part',
            'body_part5': 'body_part',
            'body_part6': 'body_part',
            'body_part7': 'body_part',
            'body_part8': 'body_part',
            'cond_factor2': 'cond_factor',
            'consq2': 'consq',
            'consq3': 'consq',
            'equip_factor2': 'equip_factor',
            'haz_id_fail2': 'haz_id_fail',
            'human_factor2': 'human_factor',
            'inattention2': 'inattention',
            'mgmt_factor2': 'mgmt_factor',
            'object2': 'object',
            'ppe_cond2': 'ppe_cond',
            'site_cond2': 'site_cond',
            'site_cond3': 'site_cond',
            'tool_cond2': 'tool_cond',
            'tool_cond3': 'tool_cond',
            'tool_cond4': 'tool_cond',
            'train_gap2': 'train_gap',
...
ROLE_PH_MAP = {
    ...
    "accd": {
        'ROLE_body_part': 'some affected body part',
        'ROLE_body_part2': 'some affected body part 2',
        'ROLE_body_part3': 'some affected body part 3',
        'ROLE_body_part4': 'some affected body part 4',
        'ROLE_body_part5': 'some affected body part 5',
        'ROLE_body_part6': 'some affected body part 6',
        'ROLE_body_part7': 'some affected body part 7',
        'ROLE_body_part8': 'some affected body part 8',
        'ROLE_cond_factor': 'some working condition factors',
        'ROLE_cond_factor2': 'some working condition factors 2',
        'ROLE_consq': 'some consequences',
        'ROLE_consq2': 'some consequences 2',
        'ROLE_consq3': 'some consequences 3',
        'ROLE_equip_factor': 'some equipment factors',
        'ROLE_equip_factor2': 'some equipment factors 2',
        'ROLE_haz_id_fail': 'some failure of hazard management',
        'ROLE_haz_id_fail2': 'some failure of hazard management 2',
        'ROLE_human_factor': 'some behavioral factors',
        'ROLE_human_factor2': 'some behavioral factors 2',
        'ROLE_inattention': 'some inattentive behavior',
        'ROLE_inattention2': 'some inattentive behavior 2',
        'ROLE_mgmt_factor': 'some managerial factors',
        'ROLE_mgmt_factor2': 'some managerial factors 2',
        'ROLE_object': 'some object involved',
        'ROLE_object2': 'some object involved 2',
        'ROLE_ppe_cond': 'some protective equipment condition',
        'ROLE_ppe_cond2': 'some protective equipment condition 2',
        'ROLE_severity': 'some severity',
        'ROLE_site_cond': 'some workspace condition',
        'ROLE_site_cond2': 'some workspace condition 2',
        'ROLE_site_cond3': 'some workspace condition 3',
        'ROLE_task': 'some construction trade',
        'ROLE_tool_cond': 'some work equipment condition',
        'ROLE_tool_cond2': 'some work equipment condition 2',
        'ROLE_tool_cond3': 'some work equipment condition 3',
        'ROLE_tool_cond4': 'some work equipment condition 4',
        'ROLE_train_gap': 'some deficiency in safety training',
        'ROLE_train_gap2': 'some deficiency in safety training 2',
        'ROLE_violation': 'some noncompliant behavior',
        'ROLE_violation2': 'some noncompliant behavior 2',
        'ROLE_weather': 'some weather condition',
        'ROLE_work_ctx': 'some working circumstances',
        'ROLE_work_ctx2': 'some working circumstances 2',
    },
}
