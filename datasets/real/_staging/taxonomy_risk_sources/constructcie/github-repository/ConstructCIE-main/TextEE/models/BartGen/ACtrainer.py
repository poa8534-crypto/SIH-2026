...
from .EAEtrainer import BartGenEAETrainer, EAE_collate_fn, get_arg_objects, get_span_idx
from .pattern import patterns

logger = logging.getLogger(__name__)


class BartGenACTrainer(EAEACMixin, BartGenEAETrainer):
    """AC trainer for BartGen (EAE-based, two-stage hierarchical inference)."""
