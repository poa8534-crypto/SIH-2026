...
from .EAEtrainer import EEQAEAETrainer, EAE_collate_fn

logger = logging.getLogger(__name__)


class EEQAACTrainer(EAEACMixin, EEQAEAETrainer):
    """AC trainer for EEQA (EAE-based, two-stage hierarchical inference)."""
