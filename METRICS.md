...
cd frontend && npx vitest run                # 101 passed (991 total)
python eval.py                               # §3.1
...
Test counts as of this reconciliation: **890 pytest + 101 vitest = 991**
...
| 435 / 400 / 319 / 264 / 580 / 881 tests | `README.md`, `Basics.md`, `Audit-1.md`, `SETUP.md`, this file | **890 pytest, 101 vitest** | Suite grew. 580 was right on 2026-09-01; 881/55 was right on the LLM branch before it merged with the demo-fix branch, which added the frontend tests |
